...
IF %ERRORLEVEL% NEQ 0 GOTO WINGET_ERROR
...
ECHO [ACTION] Veuillez installer Python manuellement : https://www.python.org/downloads/
PAUSE
EXIT /B
...
IF %ERRORLEVEL% EQ 0 GOTO SETUP_VENV
